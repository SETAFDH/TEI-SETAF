...
Description des fichiers HTML :
  ...
  - Chaque fichier .html <b>reg</b> présente, de façon plus lisible, les lignes de texte tirées des balises <b>reg type="intermediary"</b>. Il s'agit de la régularisation (niveau intermédiaire) du texte source produite grâce au guide de normalisation du projet SETAF.
  - Chaque fichier .html <b>cont</b> présente, de façon plus lisible, les lignes de texte tirées des balises <b>reg type="contemporary"</b>. Il s'agit de la traduction du texte source en français contemporain, une étape qui ne concerne que certains textes.

Chaque version .html <b>orig</b>, <b>reg</b> ou <b>cont</b>, est ajoutée quand le travail sur les lignes de texte tirées des balises corréspodantes, dans le fichier XML-TEI, est terminé (qualité *gold*).
